...
then
    echo $(sf project deploy start -a 54.0 -o $SOURCE_ORG_ALIAS -x package/package.xml -l RunSpecifiedTests -t $(cat ./testclass/testclass.txt) --verbose --dry-run -w 10) | tee ./DEPLOY_ORG.txt
